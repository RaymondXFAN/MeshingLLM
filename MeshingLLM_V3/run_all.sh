#!/usr/bin/env bash
# run_all.sh — MeshingLLM ICEBE2026 审稿修改版实验一键复现（CPU版）
# ⭐ 路径自动检测：脚本所在目录 = 项目根目录
set -e
...
echo "================================================"
echo "  MeshingLLM · ICEBE 2026 审稿版实验（CPU模式）"
echo "  ⭐ 项目路径（自动检测）: ${SCRIPT_DIR}"
...
echo ""
echo "==== [5/5] 统计分析 ===="
# ⭐⭐⭐ 路径修正：outputs在项目根目录下，不是../outputs/
...
echo ""
echo "  ⭐ 结果文件位置: ${SCRIPT_DIR}/outputs/"
echo ""
